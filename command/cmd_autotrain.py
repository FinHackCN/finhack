...
def auto_lgbtrain(factor_list,loss='ds'):
...
for i in range(0,1000):
    try:
        ...
        #factor_list=['close','open']
        print(factor_list)        
        print("start ds train")
        auto_lgbtrain(factor_list=factor_list,loss='ds')
        print("start mse train")
        auto_lgbtrain(factor_list=factor_list,loss='mse')
